...
router.put("/profile", authMiddleware, upload.single('profileUrl'), asyncHandler(userInfoController.changeProfile));
router.put("/default", authMiddleware, asyncHandler(userInfoController.defaultProfile));
